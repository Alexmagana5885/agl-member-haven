...
# MPESA_ACCOUNT_REFERENCE = os.environ.get("MPESA_ACCOUNT_REFERENCE_REGISTRATION", "6175135")
MPESA_ACCOUNT_REFERENCE = os.environ["MPESA_ACCOUNT_REFERENCE_REGISTRATION"]

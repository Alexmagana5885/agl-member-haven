...
const pastEvents = [
  { title: "National Library Week Symposium 2025", venue: "KICC, Nairobi", date: "10 Nov 2025" },
  { title: "Records Management Training", venue: "Moi University, Eldoret", date: "22 Sep 2025" },
  { title: "Government Information Access Forum", venue: "Kenya School of Government, Nairobi", date: "5 Jul 2025" },
];
      ...
      <CardContent>
        <div className="space-y-3">
          {pastEvents.map((evt, i) => (
            <div key={i} className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 rounded-lg bg-accent/50 p-4">
